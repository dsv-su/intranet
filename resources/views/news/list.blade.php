    ...
    <div class="px-4 mx-auto max-w-2xl">
        ...
        <a class="mb-3 group flex flex-col border border-blue-600 hover:border-transparent hover:shadow-lg
            ...
            <div class="space-y-5 md:space-y-8">
                <div class="space-y-3">
                    <h2 class="text-xl font-normal md:text-xl dark:text-white"> {!! $collection->title !!} </h2>
                    <p class="text-lg text-gray-800 dark:text-gray-200">{!! \Illuminate\Support\Str::limit($collection->content, 38) !!}</p>
                </div>
            </div>
        </a>
        <!-- End Card -->
