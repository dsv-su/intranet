<div>
    @if($allow && in_array($type, ['granted', 'rejected']))
        <div class="mb-4 mt-4 bg-green-50 border border-green-500 text-sm text-gray-500 rounded-lg p-5 dark:bg-purple-600/[.15]">
            <h3 class="mb-4 text-blue-600 font-semibold dark:font-medium dark:text-white">Decision Letter!</h3>
            <div x-data="finalUpload()">
                @include('livewire.pp.partials.decisionfileupload_progress')
                ...
                <script>
                    function finalUpload() {
                        return {
                            ...
                            @this.uploadMultiple('decisionfiles', files,
                                function (success) {
                            ...
                            @this.removeUpload('decisionfiles', filename);
                            },
                        }
                    }
                </script>
