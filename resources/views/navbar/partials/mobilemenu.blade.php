    ...
    <ul class="px-2 pt-2 pb-3 space-y-1">
        ...
        <li>
            ...
            <div x-show="activeMobileMenu === 'getting-started'" class="pl-4 space-y-1" x-transition>
                <a href="{{route('budget-template')}}" @click="mobileMenuOpen = false; activeMobileMenu = ''" class="block px-3 py-2 rounded-md text-base font-medium text-neutral-700 hover:bg-neutral-100 dark:text-white">
