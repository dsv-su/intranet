                            ...
                            <td class="size-px whitespace-nowrap">
                                <div class="px-6 py-1.5">
                                    ...
                                    <div id="dropdownDotsHorizontal" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                                        ...
                                        <div class="py-2">
                                            <a href="{{route('pp-delete', $proposal->id)}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Archive</a>
                                        </div>
                                    </div>
